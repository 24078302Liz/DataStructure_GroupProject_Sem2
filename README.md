...
| **Beby Azzura (Rara)** <br>*(24201647)* | Integration & UI | Wrote the main loop console harness, implemented safe token-based input scanners, and fused the BST-to-Stack workflow. |
